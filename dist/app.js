...
// Define routes
router.route('/', '/views/index.html');
router.route('/about', '/views/about.html');
router.route('/contact', '/views/contact.html');
router.route('/events', '/views/events.html');
router.route('/gallery', '/views/gallery.html');
router.route('/login', '/views/login.html');
router.route('/opportunities', '/views/opportunities.html');
router.route('/privacy', '/views/privacy.html');
router.route('/terms', '/views/terms.html');
router.route('/404', '/views/404.html');
router.route('/statistics', '/views/statistics.html');
router.route('/event-planning', '/views/event-planning.html');
